...
const ProjectCard = () => {
  return (
    <GlassCard className="sm:p-5! ">
      <div className="flex sm:flex-row-reverse sm:h-90 h-100 flex-col items-center align-middle">
        <img
          className="sm:w-3/5 ml-3 border-[0.5px] border-black/30 dark:border-white/50 sm:h-full h-3/4 w-3/4  object-cover rounded-xl "
          src={Project}
        />
        <div className="flex flex-col sm:items-start items-center sm:p-0 p-5 pt-3 gap-3 sm:mt-0 mt-2 sm:mx-0 mx-20">
          ...
          <p className="sm:text-[14px] text-[12px] font-mono font-extralight leading-tight text-justify sm:text-start">
            ...
            Laudantium saepe ipsam atque nesciunt sapiente exercitationem
            laborum doloribus illo debitis corrupti deleniti praesentium aliquid
            aut, laboriosam repellat? Odio id rerum quae?
          </p>
          <div className="flex sm:gap-5 gap-40 text-[14px] pt-5">
